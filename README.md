...
## Shoreline evolution of Valencia lake and land use and land cover changes in Zamora municipality, Aragua state, Venezuela, period 1986-2016 [<img src="https://acoiman.github.io/opendata.png"  alt="Open Data Badge" width="35" height="35" />](https://www.cos.io/initiatives/badges "Open Data Badge")
...
- [**keplergl_map**](https://github.com/acoiman/lulc_zamora_1986_2016/tree/master/keplergl_map): contains a Jupyter Notebook showing how we created a [web map of LULC](https://github.com/acoiman/paper_01/) using [Kepler.GL](https://kepler.gl/). 
